...
export default function Hero() {
    return (
        <section id="home" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-[#eefbf9]">
            {/* Decorative blob/gradient background - approximated */}
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-[#d0f0eb] to-transparent opacity-50 rounded-bl-full -z-10" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left space-y-6">
                        <div className="flex justify-center lg:justify-start">
                            <Badge variant="soft" className="px-4 py-1 text-sm font-medium rounded-full bg-[#dbeceb] text-[#3a8d84] border-0 flex items-center gap-2">
            ...
            */}
                ...
                */}
                            ...
                            <div className="absolute top-1/3 right-10 bg-white p-3 rounded-xl shadow-lg animate-bounce">
                                <span className="text-sm font-semibold text-[#3a8d84]">AI Powered</span>
                            </div>
