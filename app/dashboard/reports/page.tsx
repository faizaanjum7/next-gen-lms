...
export default function ReportsPage() {
    return (
        <div className="p-6 md:p-8 w-full max-w-[1240px] mx-auto min-h-screen">
            {/* Header Section */}
            <div className="mb-6">
                <h2 className="text-[24px] md:text-[28px] font-bold text-gray-900 mb-1 leading-tight">
                    Learning Report
                </h2>
                <p className="text-[14px] md:text-[15px] font-semibold text-gray-900 leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[13px] font-medium text-gray-900">Profile Progress</span>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[13px] font-medium text-gray-900">Learning Score</span>
                        ...
                        <span className="text-[11px] text-gray-400">Based on recent assessments</span>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[13px] font-medium text-gray-900">Skill Level</span>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
                <div className="flex-1 relative">
                    <select className="w-full appearance-none border border-gray-200 rounded-lg py-2.5 pl-4 pr-10 text-[14px] text-gray-900 bg-white outline-none focus:border-[#3bc4b6]">
            ...
            {/* Summary Box */}
            <div className="bg-white border border-gray-300 rounded-lg p-5 md:p-6 mb-4">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div>
                        <h3 className="text-[18px] font-semibold text-gray-900 mb-1">Hi User</h3>
                    ...
                    {/* Badges */}
                    <div className="flex bg-white border border-gray-200 rounded-md overflow-hidden self-start">
                        <button className="px-5 py-1.5 text-[13px] font-medium text-gray-500 hover:bg-gray-50 transition-colors">
                            Beginner
                        </button>
                ...
                <div className="flex flex-col gap-3 text-[14px] font-medium text-gray-500">
                    <p>Score: 16/16</p>
            ...
            <div className="flex justify-between px-[5%] text-[12px] font-medium text-gray-900 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                ...
                <div className="bg-white border border-gray-300 rounded-lg p-5">
                    <div className="flex justify-between items-start mb-8">
                        <h4 className="text-[15px] font-bold text-gray-900">Performance by Section</h4>
                        <div className="flex items-center gap-4 text-[11px] font-semibold text-gray-900">
                    ...
                    <div className="relative h-[200px] w-full flex pl-8 pb-8">
                        ...
                        {/* X Axis Label */}
                        <div className="absolute bottom-0 left-0 right-0 text-center text-[10px] font-semibold text-gray-900 mt-2">
                            Assessment Name
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-300 rounded-lg p-5">
                    <div className="flex justify-between items-start mb-8">
                        <h4 className="text-[15px] font-bold text-gray-900">Accuracy</h4>
                        <div className="flex items-center gap-4 text-[11px] font-semibold text-gray-900">
                            <div className="flex items-center gap-1.5">
                                <div className="w-2.5 h-2.5 rounded-sm bg-[#52b7b0]" />
                                <span>Average</span>
